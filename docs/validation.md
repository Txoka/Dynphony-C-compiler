...
- Fixed-address demonstration: **662 bytes**, returned **146**, 951 emulated instructions. Before the optimization passes it was 1,572 bytes and 2,195 instructions.
- PIC demonstration: **848 bytes**, loaded at `0x12345`, returned **146**, 1,202 emulated instructions. Before the optimization passes it was 1,708 bytes and 2,319 instructions.
